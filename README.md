...
This repository contains the survey design, research questions, and Prolific deployment configuration for our global business study on **AI-nization and Psychological Safety**.
...
*   **[survey_questions_plan.md](survey_questions_plan.md):** The complete set of academic survey questions covering all four tracks:
    1.  *Track 1:* AI-nization & Psychological Safety (our core focus)
...
*   **[ai-nization-survey.yaml](ai-nization-survey.yaml):** The Prolific CLI configuration file used to programmatically register and structure the study.
...
## 🤖 Research Focus: "AI-nization" & Psychological Safety
